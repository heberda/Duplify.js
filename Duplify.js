(function ($) {
    $.fn.duplify = function (options) {
        ...
        $table.find('th:last').after('<th><span id="new-lineitem" class="glyphicon glyphicon-plus link-hover"></span></th>');
        ...
        $("#new-lineitem").bind('click', function () {
            ...
            if (opts.canRemove) { $newRow.find('td:last').append('<span class="glyphicon glyphicon-remove remove-row link-hover"></span>'); }
        });
